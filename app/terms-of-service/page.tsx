...
export default function TermsOfServicePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white/90 flex flex-col" style={{ scrollBehavior: "auto" }}>
            ...
            <div className="prose prose-lg max-w-none prose-invert">
              ...
              <div className="mb-12">
                ...
                <p className="text-neutral-300 leading-relaxed mb-4">
                  ...
                  agents from and against any claims, damages, obligations, losses, liabilities, costs, or debt, and
                  expenses (including but not limited to attorney's fees) arising from your use of our website or
                  services.
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-neutral-300 leading-relaxed mb-4">
                  These Terms shall be governed by and construed in accordance with the laws of the Kingdom of Saudi
                  Arabia. Any disputes arising under or in connection with these Terms shall be subject to the exclusive
                  jurisdiction of the courts of the Kingdom of Saudi Arabia.
                </p>
              </div>

              <div className="mb-12">
                <h2 className="text-h3 font-semibold text-white mb-2">Termination</h2>
                <p className="text-neutral-300 leading-relaxed mb-4">
              ...
              <div className="mb-12">
                ...
                <div className="bg-neutral-800 p-6 rounded-lg mb-4">
                  {" "}
                  {/* Adjusted background for contrast */}
      ...
      <Footer /> {/* Footer is already dark-themed */}
    </div>
  )
}
