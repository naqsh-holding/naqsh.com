        ...
        <div className="container mx-auto px-4 py-16">
          <div ref={contentRef}>
            ...
            <div className="prose prose-lg max-w-none prose-invert">
              ...
              <div className="mb-8">
                <h2 className="text-h3 font-semibold text-white mb-2">Your Rights and Choices</h2>
                <p className="text-neutral-300 leading-relaxed mb-4">
              ...
              <div className="mb-8">
                <h2 className="text-h3 font-semibold text-white mb-2">Cookies and Tracking Technologies</h2>
                <p className="text-neutral-300 leading-relaxed mb-4">
                  We use cookies and similar tracking technologies to enhance your experience on our website, analyze
                  usage patterns, and provide personalized content. You can control cookie settings through your
                  browser preferences.
                </p>
              </div>

              <div className="mb-8">
                <h2 className="text-h3 font-semibold text-white mb-2">Third-Party Links</h2>
                <p className="text-neutral-300 leading-relaxed mb-4">
                  Our website may contain links to third-party websites, including our portfolio companies. We are
              ...
              <div className="mb-8">
                <h2 className="text-h3 font-semibold text-white mb-2">Children's Privacy</h2>
                <p className="text-neutral-300 leading-relaxed mb-4">
                  Our website and services are not intended for children under the age of 18. We do not knowingly
                  collect personal information from children under 18. If you believe we have collected information
              ...
              <div className="mb-8">
                <h2 className="text-h3 font-semibold text-white mb-2">Contact Us</h2>
                <p className="text-neutral-300 leading-relaxed mb-4">
