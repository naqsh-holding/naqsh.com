    ...
    return (
      <div className="min-h-screen bg-white text-black">
        ...
        <div className="container mx-auto px-6 pt-32">
          <h1 className="text-4xl font-light text-black">Project not found</h1>
        </div>
        <Footer />
      </div>
    )
